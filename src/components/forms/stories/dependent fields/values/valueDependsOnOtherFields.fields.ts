import {DynamicValidationFormFields} from "../validation/validationDependsOnOtherField.models";
import {formFields} from "../../../fields/FieldComponentMapper";
import {RuleObject} from "rc-field-form/lib/interface";

export const valueDependsOnOtherFieldFields: DynamicValidationFormFields = [
    {
        name: 'A',
